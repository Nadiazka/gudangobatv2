...
@method_decorator(login_required, name='dispatch')
class DrugsViewDetail(generics.RetrieveUpdateDestroyAPIView):
	#permission_classes = [permissions.IsAuthenticated, TokenHasReadWriteScope]
	queryset = Drugs.objects.all()
	serializer_class = DrugsSerializer
...
@method_decorator(login_required, name='dispatch')
class PuskesmasViewDetail(generics.RetrieveUpdateDestroyAPIView):
	#permission_classes = [permissions.IsAuthenticated, TokenHasReadWriteScope]
	queryset = Puskesmas.objects.all()
	serializer_class = PkmSerializer
...
@method_decorator(login_required, name='dispatch')
class DrugsQuantityViewDetail(generics.RetrieveUpdateDestroyAPIView):
	#permission_classes = [permissions.IsAuthenticated, TokenHasReadWriteScope]
	queryset = DrugsQuantity.objects.all()
	serializer_class = DQSerializer